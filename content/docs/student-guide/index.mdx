...
<Verify>この、スタート画面が表示されれば起動完了です。</Verify>
...
<Verify>この、メイン画面が開けば起動成功です。</Verify>
...
<Action img="./img/how-to-translate-with-translation-gizmo.png">
  配置したキューブのギズモのハンドルをドラッグして歩いて触れる高さに移動します
</Action>
...
<Section title="2-2. 動作確認" goal="キューブに触れても何も起きないことを確認します">
...
<Action img="./img/compile-success.png">
  このようにコンパイルのアイコンが**緑のチェック**になれば、エラーがない状態です。
</Action>
...
<Section title="3-6. テストプレイで確認する" goal="アイテムに触れるとスコアが増えてアイテムが消えることを確認します">
...
<Section title="4-2. テストプレイで確認する" goal="5 個目のアイテムを取った瞬間に「CLEAR!」が表示されることを確認します">
