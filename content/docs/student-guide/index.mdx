...
<Section title="1-1. Unreal Engine 5.7 を起動する" goal="Unreal Engine 5.7 のスタート画面（プロジェクト選択画面）が表示されます">

<Action img="./img/startup.png">
  **Unreal Engine 5.7** を起動します
</Action>

<Verify>プロジェクト選択画面（最近のプロジェクト・新規プロジェクトのタブがある画面）が表示されれば起動完了です。</Verify>
