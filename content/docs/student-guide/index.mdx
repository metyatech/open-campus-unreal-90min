...
:::important
プレイ中に困ったときは、**Esc キー**を押すとテストプレイを終了できます。
:::
...
<Action img="./img/convert-to-blueprint-window-process.png">
  ブループリント名を「**BP_Item**」にして「**選択**」をクリックします（その他の項目は画像の通り「そのまま」で OK）
</Action>
...
<Action img="./img/add-Score-variable.png">
  「**マイブループリント**」パネルの「**＋**」から、名前「**Score**」・型「**Integer**」の変数を追加します
</Action>
...
<Action img="./img/how-to-BP_Item_OverlapAllDynamic.png">
  コンテンツブラウザで「**BP_Item**」をダブルクリックして Blueprint エディタを開き、①〜③ の通り「**Generate Overlap Events**」をオン、「**コリジョンプリセット**」を「**OverlapAllDynamic**」にします
</Action>
