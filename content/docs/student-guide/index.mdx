...
<Action img="./img/place-cube.png">
  画像の ① → ② の順でメニューをたどり、③ **キューブ**をドラッグ&ドロップ、または、クリックで、ビューポートに**キューブ**を置きます
</Action>
...
<Action img="./img/convert-to-blueprint-window-process.png">
  ③ ブループリント名を「**BP_Item**」にして、他は画像の通りにして（元々画像の通りになっているはず）、⑤「**選択**」をクリックします
</Action>
...
<Action img="./img/BP_Item-print-string-from-actorbeginoverlap.png">
  ここまでのイベントグラフがこの形になっていることを確認します
</Action>
...
<Action img="./img/increment-score-overview.png">
  ここまでの Blueprint 全体がこの形になっていることを確認します
</Action>
